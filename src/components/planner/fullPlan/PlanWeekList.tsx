    ...
    <section aria-label="Weeks to the exams" className="space-y-5">
      {earlierWeeks > 0 && (
        <button
          ...
          className="btn-ghost inline-flex h-11 sm:h-8 items-center gap-1.5 rounded-lg px-2.5 text-xs"
        >
      ...
      {hiddenWeeks > 0 && (
        <button
          type="button"
          onClick={onShowRest}
          className="btn-soft flex w-full items-center justify-center gap-1.5 rounded-xl px-4 py-2.5 min-h-11 sm:min-h-0 text-sm"
        >
