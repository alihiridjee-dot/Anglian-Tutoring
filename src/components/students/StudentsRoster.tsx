        ...
        <table className="w-full text-sm">
          <thead className="bg-muted/60 text-muted-foreground text-xs tracking-widest uppercase">
            <tr>
              ...
              <th className="hidden px-5 py-3 text-left md:table-cell">Course</th>
              <th className="px-5 py-3 text-left">Plan</th>
              <th className="hidden px-5 py-3 text-left lg:table-cell">Last active</th>
                ...
                return (
                  <tr key={s.id} className="hover:bg-muted/30 group relative">
                    <td className="px-5 py-3">
                      ...
                      <p className="text-muted-foreground mt-0.5 text-xs">{s.email}</p>
                    </td>
                    ...
                    <td className="text-muted-foreground hidden px-5 py-3 text-xs lg:table-cell">
