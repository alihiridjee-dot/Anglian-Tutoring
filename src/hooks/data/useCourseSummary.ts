...
import { summariseCourse, type CourseSummary } from "@/lib/curriculum/courseSummary";

/**
 * The current user's course — level plus the board of each enrolled subject.
 *
 * The labelling rules live in `@/lib/curriculum/courseSummary` (pure, testable); this is
