...
import { resolveEducationalVideo } from "@/lib/videoMapper";
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {
            data.map((v) => {
              ...
              let displayDesc = v.description;

              if (v.video_url === "https://www.youtube.com/watch?v=dQw4w9WgXcQ" || !v.video_url) {
                const resolved = resolveEducationalVideo(
                  v.board || "ocr",
                  v.subject || "biology",
                  v.level || "gcse",
                  "",
                ...
                displayDesc = resolved.description;
              }
