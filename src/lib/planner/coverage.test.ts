...
describe("weekly completion window", () => {
  test("previous practice does not finish a newly assigned review", () => {
    expect(practiceInWeek(new Date("2026-09-06T23:59:00+01:00").toISOString(), "2026-09-07")).toBe(
      false,
    );
    expect(practiceInWeek(new Date("2026-09-07T00:00:00+01:00").toISOString(), "2026-09-07")).toBe(
      true,
    );
    expect(practiceInWeek(new Date("2026-09-13T23:59:00+01:00").toISOString(), "2026-09-07")).toBe(
      true,
    );
    expect(practiceInWeek(new Date("2026-09-14T00:00:00+01:00").toISOString(), "2026-09-07")).toBe(
      false,
    );
  });
